    ...
    return (
        <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto mb-8">
                ...
                <NavButton to="/app/recibos">
                    <div className="flex flex-col items-center gap-2">
                        <Receipt className="w-8 h-8" />
                        <span>Emitir Recibo</span>
                    </div>
                </NavButton>
                <NavButton to="/app/cnae">
                    <div className="flex flex-col items-center gap-2">
                        <Search className="w-8 h-8" />
                        <span>Consulta CNAE</span>
                    </div>
                </NavButton>
                <NavButton to="/app/contratos">
                    <div className="flex flex-col items-center gap-2">
                ...
                {isAdmin && (
                    <NavButton to="/app/gerenciar-contador">
                        <div className="flex flex-col items-center gap-2">
                            <UserCog className="w-8 h-8" />
                            <span>Cadastrar Contador</span>
                        </div>
                    </NavButton>
                )}
            </div>
